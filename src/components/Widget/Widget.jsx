        ...
        <div className="widget_options">
            ...
            <div className="widget_content">
                ...
                <div className="widget_contentTitle">
                    <div className="widget_heading">Money Control</div>
                    <p>
            ...
            <div className="widget_content">
                ...
                />
                <div className="widget_contentTitle">
                    <div className="widget_heading">Art & Artist</div>
                    <p>
            ...
            <div className="widget_content">
                ...
                />
                <div className="widget_contentTitle">
                    <div className="widget_heading">Mobile App Programmer</div>
                    <p>
            ...
            <div className="widget_content">
                ...
                />
                <div className="widget_contentTitle">
                    <div className="widget_heading">Quota of Quotes</div>
                    <p>
            ...
            <div className="widget_content">
                ...
                />
                <div className="widget_contentTitle">
                    <div className="widget_heading">Friedrich Nietzche</div>
                    <p>
